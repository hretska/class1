...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"main4.js":[function(require,module,exports) {
...
window.addEventListener("load", function () {
  ...
  var test1 = document.getElementById("p");
  fetch('https://jsonplaceholder.typicode.com/todos/1').then(function (response) {
    return response.json();
  }).then(function (json) {
    return test1.innerHTML = '<h1>' + json.title + '</h1>';
  });
  ...
  if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(function (position) {
      ...
      var api = "https://api.openweathermap.org/data/2.5/weather?lat=".concat(lat, "&lon=").concat(long, "&appid=f54e32240f7ce26e110f4531e263bf25");
      fetch(api).then(function (response) {
        return response.json();
      }).then(function (data) {
        console.log(data);
        var temp = data.main.temp;
        var description = data.weather[0].description; //Set DOM Elements from the API

        temperatureDegree.textContent = parseInt(temp) - 273;
        temperatureDescription.textContent = description;
        locationTimezone.textContent = data.name + " / " + data.sys.country; //Change temperature to Celsius/Farenheit
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","main4.js"], null)
//# sourceMappingURL=/main4.4cde7ff5.js.map